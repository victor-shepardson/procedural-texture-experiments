...
float[] upperRange =  {128,            128,         PI,          PI,             .125,        5};
String[] suffix = {"X", "Y", "Z"};
...
void setup() { 
  ...
  int sliderWidth=min(256, noiseWidth-128);
  int sliderHeight=8;
  int sliderSpacing=4;
